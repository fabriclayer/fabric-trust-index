...
export const GOLDEN_SET: GoldenService[] = [
  ...
  // ═══ SHOULD BE TRUSTED (min 3.25) ═══
  { slug: 'spacy', name: 'spaCy', expected_status: 'trusted', min_composite: 3.25, max_composite: 5.0, required_signals: REGISTRY_SIGNALS, notes: 'Established NLP library' },
  { slug: 'instructor', name: 'Instructor', expected_status: 'trusted', min_composite: 3.25, max_composite: 5.0, required_signals: REGISTRY_SIGNALS, notes: 'Popular structured output library' },
  { slug: 'langchain-core', name: '@langchain/core', expected_status: 'trusted', min_composite: 3.25, max_composite: 5.0, required_signals: REGISTRY_SIGNALS, notes: 'LangChain core package' },
  { slug: 'chromadb', name: 'ChromaDB', expected_status: 'trusted', min_composite: 3.25, max_composite: 5.0, required_signals: REGISTRY_SIGNALS, notes: 'Popular vector DB' },
  { slug: 'modelcontextprotocol-sdk', name: '@modelcontextprotocol/sdk', expected_status: 'trusted', min_composite: 3.25, max_composite: 5.0, required_signals: REGISTRY_SIGNALS, notes: 'Anthropic MCP SDK' },
  { slug: 'replicate', name: 'Replicate', expected_status: 'trusted', min_composite: 3.25, max_composite: 5.0, required_signals: REGISTRY_SIGNALS, notes: 'Established inference provider' },

  // ═══ SHOULD NOT BE BLOCKED — popular packages currently miscoring ═══
  { slug: 'tensorflow', name: 'tensorflow', expected_status: 'trusted', min_composite: 3.25, max_composite: 5.0, required_signals: REGISTRY_SIGNALS, notes: 'Google ML framework — currently 0.99 blocked (scoring bug)' },
  { slug: 'gradio', name: 'Gradio', expected_status: 'trusted', min_composite: 3.25, max_composite: 5.0, required_signals: REGISTRY_SIGNALS, notes: 'HuggingFace demo framework — currently 0.99 blocked' },
  { slug: 'mlflow', name: 'MLflow', expected_status: 'trusted', min_composite: 3.25, max_composite: 5.0, required_signals: REGISTRY_SIGNALS, notes: 'Databricks MLOps — currently 0.99 blocked' },
  { slug: 'pillow', name: 'Pillow', expected_status: 'trusted', min_composite: 3.25, max_composite: 5.0, required_signals: REGISTRY_SIGNALS, notes: 'Python imaging — currently 0.99 blocked' },
