        ...
        <div className="bg-black border border-fabric-700 rounded-xl p-8 flex flex-col gap-6 mt-4 relative overflow-hidden max-md:p-6">
          ...
          <div className="flex items-center justify-between gap-8 flex-wrap relative z-10">
            ...
            <div className="flex gap-3 flex-shrink-0">
              <button onClick={() => setShowClaimModal(true)} className="font-mono text-[0.72rem] py-2.5 px-5 bg-transparent text-pink border border-pink/40 rounded-lg cursor-pointer transition-all hover:border-pink hover:text-white whitespace-nowrap">Claim Provider</button>
              <button onClick={() => setShowReportModal(true)} className="font-mono text-[0.72rem] py-2.5 px-5 bg-transparent text-pink border border-pink/40 rounded-lg cursor-pointer transition-all hover:border-pink hover:text-white whitespace-nowrap">Report Issue</button>
            </div>
          </div>
