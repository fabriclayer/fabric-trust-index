  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className={`font-mono text-[0.68rem] text-fabric-600 bg-white border rounded-lg px-2.5 pt-[7px] pb-[8px] cursor-pointer outline-none flex items-center gap-1.5 whitespace-nowrap transition-all select-none hover:border-fabric-300 w-full ${open ? 'border-blue shadow-[0_0_0_3px_rgba(61,138,247,0.1)]' : 'border-fabric-200'}`}
      >
...
export default function SearchToolbar(props: SearchToolbarProps) {
  return (
    <div className={`sticky top-14 z-[90] bg-fabric-50/[0.92] backdrop-blur-2xl border-b border-fabric-200 py-2.5 px-8 max-md:px-4 transition-[margin] duration-200 ${props.alertsOpen ? 'mr-[360px] max-md:mr-0' : ''}`}>
      <div className="max-w-container mx-auto flex items-center gap-3 max-[480px]:gap-2 flex-wrap">
        {/* Search */}
        <div className="flex items-center gap-2 py-2 px-3.5 bg-white border border-fabric-200 rounded-[10px] min-w-[200px] max-md:w-full max-md:flex-none flex-1 transition-all focus-within:border-blue focus-within:shadow-[0_0_0_3px_rgba(61,138,247,0.1)]">
